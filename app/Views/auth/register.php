                    ...
                    <div class="card-body p-0">
                        <div class="p-5">
                            <div class="text-center">
                                <a href="<?= base_url('/'); ?>"><h1 class="h4 text-gray-900 mb-4">Create an Account!</h1></a>
                            </div>
                            <form class="user" method="POST" action="<?= base_url(); ?>/register/process">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" name="password_conf" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Repeat Password" required>
                                    </div>
                                </div>
